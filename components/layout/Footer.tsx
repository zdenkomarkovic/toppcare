    ...
    <footer className="bg-[#c4788c] text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <p className="text-sm leading-relaxed mb-6">
              ...
              negu kose u Srbiji. Kolagen, keratin, arganovo ulje – za kosu koja sija.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              <li>
                ...
                >
                  <svg className="w-4 h-4 text-white shrink-0" fill="none" stroke="currentColor" strokeWidth={1.8} viewBox="0 0 24 24">
        ...
        <div className="border-t border-white/20 mt-14 pt-8 flex flex-col md:flex-row justify-between items-center gap-3 text-xs text-white/80">
          ...
          <p>{COMPANY_LEGAL} &nbsp;·&nbsp; PIB: {COMPANY_PIB} &nbsp;·&nbsp; MB: {COMPANY_MB}</p>
          <p>
            Izrada sajta{" "}
            <a
